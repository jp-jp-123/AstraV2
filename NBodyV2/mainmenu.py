...
import button
import sys
# button and sys import, remove if unnecessary
...
# Button class
# (self.width, self.height, sense (hover()) and scale parameter is not used. Check if unnecessary and remove)
class Button:
    ...
    def draw(self):
        ...
        if self.rect.collidepoint(pos):
            ...
            if pygame.mouse.get_pressed()[0] == 1 and not self.clicked:  # prevents multiple click register
                self.clicked = True
                action = True
