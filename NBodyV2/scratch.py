...
ABOUT_PAGE = pygame.image.load(os.path.join('menu','texts','about page.png'))
OPTIONS_PAGE = pygame.image.load(os.path.join('menu','texts','options page.png'))
HELP_PAGE = pygame.image.load(os.path.join('menu','texts','help page.png'))
# HELP_CONTENT = pygame.image.load(os.path.join('menu','texts','help content.png'))
...
# button instances
vid = Video("menu/texts/astra.MOV")
vid.set_size((1280,720))
# about_vid = Video("menu/about page bg vid.mp4")
# about_vid.set_size((1280,720))
...
def main_window():
    ...
    while run:    
        if state == "home":
            ...
            options_button = Button (540,290, OPTIONS)
            help_button = Button (540,350,HELP)
            about_button = Button (542,410,ABOUT)
            exit_button = Button (540,470,EXIT)
            ...
            back_button = Button (140,590,BACK)
